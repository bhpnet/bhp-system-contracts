  ...
  methods: {
    ...
    totalStake(){
      ...
      totalStake(this.$store.state.wallet).then(res => {
        ...
        this.info="质押总量："+balance.div("1000000000000000000").toPrecision(18)+" BHP"
        this.title="查看总质押量"
        this.dialogResultVisible=true
      })
    },
