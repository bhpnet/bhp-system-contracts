...
export async function createProposal(wallet,dst,details, callback) {
    ...
    await createProposalEstimateGas(wallet,dst,details)
...
export async function createProposalEstimateGas(wallet,dst,details) {
    const contract = new wallet.web3.eth.Contract(Proposal.abi, proposalAddress)
    let web3=wallet.web3
    let txObject = {
        from: wallet.address,
        to: proposalAddress,
        data:contract.methods.createProposal(dst,details).encodeABI()
    }
...
export async function stake(wallet,validator,money,callback) {
    const contract = new wallet.web3.eth.Contract(Validators.abi, validatorsAddress)
    await stakeEstimateGas(contract,wallet,validator,money)
...
export async function stakeEstimateGas(contract,wallet,validator,money) {
    let web3=wallet.web3
    let txObject = {
        from: wallet.address,
        to: validatorsAddress,
        value:web3.utils.toWei(money, 'ether'),
        data:contract.methods.stake(validator).encodeABI()
    }
    return new Promise(async (resolve, reject) => {
        web3.eth.estimateGas(txObject).then(res => {
            resolve(res)
...
export async function withdrawProfits(wallet,validator,callback) {
    const contract = new wallet.web3.eth.Contract(Validators.abi, validatorsAddress)
    await withdrawProfitsEstimateGas(contract,wallet,validator)
...
export async function withdrawProfitsEstimateGas(contract,wallet,validator) {
    let web3=wallet.web3
    let txObject = {
        from: wallet.address,
        to: validatorsAddress,
        data:contract.methods.withdrawProfits(validator).encodeABI()
    }
    return new Promise(async (resolve, reject) => {
        web3.eth.estimateGas(txObject).then(res => {
            resolve(res)
...
export async function withdrawStaking(wallet,validator,callback) {
    const contract = new wallet.web3.eth.Contract(Validators.abi, validatorsAddress)
    await withdrawStakingEstimateGas(contract,wallet,validator)
...
export async function withdrawStakingEstimateGas(contract,wallet,validator) {
    let web3=wallet.web3
    let txObject = {
        from: wallet.address,
        to: validatorsAddress,
        data:contract.methods.withdrawStaking(validator).encodeABI()
    }
    return new Promise(async (resolve, reject) => {
        web3.eth.estimateGas(txObject).then(res => {
            resolve(res)
...
export async function unstake(wallet,validator,callback) {
    const contract = new wallet.web3.eth.Contract(Validators.abi, validatorsAddress)
    await unStakeEstimateGas(contract,wallet,validator)
...
export async function unStakeEstimateGas(contract,wallet,validator) {
    let web3=wallet.web3
    let txObject = {
        from: wallet.address,
        to: validatorsAddress,
        data:contract.methods.unstake(validator).encodeABI()
    }
    return new Promise(async (resolve, reject) => {
        web3.eth.estimateGas(txObject).then(res => {
            resolve(res)
